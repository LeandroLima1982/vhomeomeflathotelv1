...
import { AvailabilityResultsV3 } from "@/components/hotel/AvailabilityResultsV3";
...
const BookingV3 = () => {
  ...
  useEffect(() => {
    ...
    const fetchInitialData = async () => {
      if (!supabase) {
        console.error('Supabase client not available in BookingV3 fetchInitialData');
        return;
      }
