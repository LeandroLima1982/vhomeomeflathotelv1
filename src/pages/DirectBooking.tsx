...
const DirectBooking = () => {
  ...
  useEffect(() => {
    ...
    const fetchInitialData = async () => {
      if (!supabase) {
        console.error('Supabase client not available in DirectBooking fetchInitialData');
        return;
      }
  ...
  const handleSearch = async (params: SearchParams) => {
    ...
    try {
      ...
      console.error("Erro ao buscar disponibilidade no Fluxo Direto:", e);
          ...
          <div className="relative container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className={cn(
                ...
                Verifique a disponibilidade diretamente da API externa.
              </p>
            </div>
          </div>
        </section>
