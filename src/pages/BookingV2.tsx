...
const BookingV2 = () => {
  ...
  const handleSearch = async (params: SearchParams) => {
    ...
    try {
      ...
      // Buscar dados locais dos quartos para mapeamento
      ...
      // Filtrar apenas quartos com preço > 0 (removido filtro de imagem para incluir todos os quartos disponíveis)
          ...
          <div className="relative container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className={cn(
                ...
                Verifique a disponibilidade e preços para suas datas de viagem.
              </p>
            </div>
          </div>
        </section>
...
</dyad-chat-summary>Fixing missing default export in BookingV2</dyad-chat-summary><dyad-write path="src/pages/BookingV2.tsx" description="Adding the missing default export to fix the module error.">
  );
};
