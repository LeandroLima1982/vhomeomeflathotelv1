  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
      ...
      <main className="pb-20 flex-grow min-h-[600px]">
       ...
       <dyad-write path="src/pages/BookingV2.tsx" description="Adjusting the ID mapping in BookingV2.tsx to handle exceptions for API IDs 7, 12, and 13, using -4 offset for these specific rooms.">
"use client";
