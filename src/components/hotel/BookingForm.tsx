  ...
  return (
    <section className="relative z-10 -mt-20">
      <div className="container mx-auto px-4">
        <div className={`bg-black/20 backdrop-blur-lg border border-white/30 p-4 md:p-6 rounded-xl shadow-xl transition-all duration-1000 ${isMounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          <form className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4 md:items-end">
            <div className="space-y-2 text-left">
              <label className="font-medium text-white flex items-center gap-2 text-sm pl-1">
                <CalendarIcon className="h-4 w-4" /> Check-in
              </label>
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="w-full justify-start text-left font-normal bg-white/20 border-white/50 text-white placeholder:text-white/70 hover:bg-white/30">
            ...
            <div className="space-y-2 text-left">
              ...
              <Select defaultValue="2">
                <SelectTrigger className="w-full bg-white/20 border-white/50 text-white hover:bg-white/30">
