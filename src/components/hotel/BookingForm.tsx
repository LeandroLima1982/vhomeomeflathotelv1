...
export function BookingForm() {
  ...
  return (
    <div className="relative -mt-12 md:-mt-16 z-10">
      <div className="px-4">
        <div className={`max-w-4xl mx-auto bg-white border border-white/50 p-4 md:p-6 rounded-xl shadow-xl transition-all duration-1000 ${isMounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
