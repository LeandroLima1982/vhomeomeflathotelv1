...
const RoomDetailsModal = ({ room, onClose }: RoomDetailsModalProps) => {
  ...
  return (
    <Dialog open={!!room} onOpenChange={onClose}>
      <DialogContent className="max-w-[100vw] sm:max-w-[95vw] md:max-w-[90vw] lg:max-w-[1100px] max-h-[100vh] sm:max-h-[95vh] w-full p-0 bg-white border-0 shadow-2xl overflow-hidden">
        ...
        <div className="relative w-full h-80 sm:h-96 lg:h-[500px] bg-slate-100 overflow-hidden">
          {loadingImages ? (
          ...
          <div className="px-6 sm:px-8 lg:px-10 py-8 sm:py-10 lg:py-12">
            ...
            <div className="mb-10 sm:mb-12">
              ...
              {room.details?.description && room.details.description !== (room.custom_description || room.description) && (
                <div className="bg-gradient-to-r from-slate-50 to-slate-100 rounded-2xl p-6 sm:p-8 border border-slate-200/60">
